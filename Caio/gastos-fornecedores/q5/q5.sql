...
-- Universo: 57Âª Legislatura (2023-2027), Cota Parlamentar (CEAP)
--
-- SaÃ­da (via /query-staging/, copiada pelo export_respostas.py para):
--   Caio/gastos-fornecedores/q5/q5_fornecedores.txt
--   Caio/gastos-fornecedores/q5/q5_fornecedores_complemento.txt
--
...
-- fÃ­sica 'gastos' criada no init.sql jÃ¡ estÃ¡ padronizada e carregada pelo ETL.


-- =============================================================================
-- SEÃ‡ÃƒO 2 - Q5: FORNECEDORES POR VALOR (57Âª LEGISLATURA)
-- =============================================================================
...
-- =============================================================================
-- SEÃ‡ÃƒO 3 - Q5 EXTRA: TOP 10 POR CATEGORIA DE GASTO
-- =============================================================================
