...
TABLES = {
    ...
    "partidos_ideologia": {
        ...
        "columns": {
            ...
            "ideologia_score": ("ideologia_score", C.clean_decimal),
            "ideologia_faixa": ("ideologia_faixa", C.clean_text),
            "campo_ideologico": ("campo_ideologico", C.clean_text),
            "fonte_ideologia": ("fonte_ideologia", C.clean_text),
            "ano_base_ideologia": ("ano_base_ideologia", C.clean_text),
            "tipo_match_ideologia": ("tipo_match_ideologia", C.clean_text),
            "observacao_ideologia": ("observacao_ideologia", C.clean_text),
        },
    },
    "proposicoes": {
